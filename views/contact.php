   ...
   <body>
      ...
      <main class="main">
         ...
         <section class="contact" id="contact">            <div class="container">
               <div class="contenedor__contact bg_grid">

                  <div class="form__contact">
                     <h2 class="title__form">Send us a message</h2>
                     <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Voluptas dolor sapiente, earum eum hic quaerat?</p>
                     <div class="contaner__form">
                        <form action="">
                           <div class="header__form">
                              <div class="form__group">
                                 <label class="label__form" for="">Your Name</label>
                                 <input class="input__form" type="text" placeholder="Enter your name" required>
                              </div>
                              <div class="form__group">
                                 <label class="label__form" for="">Your Email</label>
                                 <input class="input__form" type="email" placeholder="Enter your email" required>
                              </div>
                           </div>
                           <div class="message__form">
                              <label class="label__form" for="">Your Message</label>
                              <textarea class="textarea__form" name="" id="" placeholder="Enter your message" required></textarea>
                           </div>
                           <div class="btn__form">
                  ...
                  <div class="img__form">
                     <img class="image__form" src="assets/img/contact/contact_form.jpg" alt="">
                     <div class="info__img">
                        ...
                        <div class="media">
                           ...
                           <a target="_blank" href="https://www.instagram.com/" class="home__icon"><i class='bx bxl-instagram' ></i></a>
                           <a target="_blank" href="https://www.youtube.com/" class="home__icon"><i class='bx bxl-youtube' ></i></a>
                           <a target="_blank" href="https://www.linkedin.com/" class="home__icon"><i class='bx bxl-linkedin' ></i></a>
                           <a target="_blank" href="https://www.twitter.com/" class="home__icon"><i class='bx bxl-twitter' ></i></a>
                        </div>
         ...
         <div class="container">
               <div class="contenedor__maps bg_grid">
                  <div class="map">
                     <iframe class="map__iframe" src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d11862.56281077698!2d-82.5076522384123!3d27.878610447877715!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1ses-419!2sco!4v1750359923423!5m2!1ses-419!2sco" width="380" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                  </div>
                  <div class="img__map">
                     <img src="assets/img/contact/info_maps.png" alt="">
                     <div class="info__map">
                        <h2>Our Location</h2>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptatum.</p>
                     </div>
